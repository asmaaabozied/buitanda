                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-from-label">{{translate('Enable Product/Published')}}</label>
                                            <div class="col-md-9">
...
{{--                                    <div class="form-group row">--}}
{{--                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('SKU')}} <span class="text-danger">*</span></label>--}}
{{--                                            <div class="col-xxl-9">--}}
{{--                                                <input type="text" class="form-control @error('sku') is-invalid @enderror" name="sku" placeholder="{{translate('Sku')}}" value="{{ optional($product->stocks->first())->sku }}">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group row" id="fulffiled">
                                        <label class="col-xxl-3 col-from-label fs-13">{{translate('Fulffiled by')}}</label>
                                        <div class="col-xxl-9">
                                            <select class="form-control aiz-selectpicker" name="fulffiled" id="fulffiled" data-live-search="true">
                                                <option value="">{{ translate('Select Fulffiled') }}</option>
                                                <option value="Express" @if($product->fulffiled == 'Express') selected @endif>Express </option>
                                                <option value="Mercado" @if($product->fulffiled == 'Mercado') selected @endif>Mercado  </option>
                                            </select>
                                            <small class="text-muted">{{translate("You can choose a Supplier if you'd like to display your product by Supplier.")}}</small>
                                        </div>
                                    </div>
...
{{--                                                    <option value="Catalog" @if($product->Visibility == 'Catalog') selected @endif>Catalog</option>--}}
{{--                                                    <option value="Search" @if($product->Visibility == 'Search') selected @endif>Search</option>--}}
{{--                                                </select>--}}
{{--                                                <small--}}
...
{{--                                        </div>--}}
                                    ...
                                    <!-- Brand -->
                                        ...
                                        <div class="form-group row" id="seller">
                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Seller')}}</label>
                                            <div class="col-xxl-9">
                                                <select class="form-control aiz-selectpicker" name="user_id" id="user_id" data-live-search="true">
                                                    ...
                                                    @foreach (\App\Models\User::where('user_type','seller')->get() as $seller)
                                                        <option value="{{ $seller->id }}" @if($product->user_id == $seller->id) selected @endif>{{ $seller->name }}</option>
                                                    @endforeach
                                                </select>
                                                <small class="text-muted">{{translate("You can choose a selller if you'd like to display your product by seller.")}}</small>
                                            </div>
                                        </div>
{{--                                        <!-- Supplier -->--}}
                                        <div class="form-group row" id="supplier">
                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Supplier')}}</label>
                                            <div class="col-xxl-9">
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" placeholder="{{ translate('Cost') }}" value="{{$product->cost}}" name="cost" class="form-control">
                                    </div>
                                </div>
                            </div>
                                @php
