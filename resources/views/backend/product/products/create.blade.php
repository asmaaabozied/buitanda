                                    ...
                                    <div class="row">
                                        <div class="col-xxl-7 col-xl-6">
                                            ...
                                            <div class="form-group row">
                                                <label
                                                    class="col-md-3 col-from-label">{{translate('Enable Product/Published')}}</label>
                                                <div class="col-md-9">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ translate('If you enable this, this product will be granted as a enable product.') }}</small>
                                                </div>
                                            </div>
...
{{--                                            </div>--}}
                                            ...
                                            {{--                                        <!-- Unit price -->--}}
                                            {{--                                        <div class="form-group row">--}}
                                            {{--                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('price')}} <span class="text-danger">*</span></label>--}}
                                            {{--                                            <div class="col-xxl-9">--}}
                                        ...
                                        <!-- ⦁	Fulffiled by  -->
                                            <div class="form-group row" id="fulffiled">
                                                <label
                                                    class="col-xxl-3 col-from-label fs-13">{{translate('Fulffiled by')}}</label>
                                                <div class="col-xxl-9">
                                                    <select class="form-control aiz-selectpicker" name="fulffiled"
                                                            id="fulffiled" data-live-search="true">
                                                        <option value="">{{ translate('Select Fulffiled') }}</option>
                                                        <option value="Express">Express</option>
                                                        <option value="Mercado">Mercado</option>
                                                    </select>
                                                    <small
                                                        class="text-muted">{{translate("You can choose a Supplier if you'd like to display your product by Supplier.")}}</small>
                                                </div>
                                            </div>
                                            {{--                                        <!-- Quantity -->--}}
                                            {{--quanity--}}
                                            {{--                                        <div class="form-group row">--}}
                                            {{--                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Quantity')}} <span class="text-danger">*</span></label>--}}
                                            {{--                                            <div class="col-xxl-9">--}}
                                            ...
                                            {{--                                        Stock--}}
                                            {{--                                        <div class="form-group row">--}}
                                            {{--                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Stock Status')}}</label>--}}
                                            {{--                                            <div class="col-xxl-9">--}}
                                            ...
                                            {{--                                        Category--}}
                                            {{--                                        <div class="form-group row">--}}
                                            {{--                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Category')}}</label>--}}
                                            {{--                                            <div class="col-xxl-9">--}}
...
{{--                                            <div class="form-group row">--}}
{{--                                                <label--}}
{{--                                                    class="col-md-3 col-from-label">{{translate('Visibility')}}</label>--}}
{{--                                                <div class="col-xxl-9">--}}
{{--                                                    <select class="form-control aiz-selectpicker" name="Visibility"--}}
{{--                                                            id="Visibility" data-live-search="true">--}}
{{--                                                        <option value="">{{ translate('Select Visibility') }}</option>--}}
{{--                                                        <option value="Catalog">Catalog</option>--}}
{{--                                                        <option value="Search">Search</option>--}}
{{--                                                    </select>--}}
{{--                                                    <small--}}
{{--                                                        class="text-muted">{{translate("You can choose a Visibility if you'd like to display your product by Visibility.")}}</small>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
                                            {{--brand--}}
                                                ...
                                                <div class="col-xxl-9">
                                                    <select class="form-control aiz-selectpicker" name="brand_id"
                                                        ...
                                                        @foreach (\App\Models\Brand::all() as $brand)
                                                            <option value="{{ $brand->id }}" @selected(old('brand_id')==
                                                            $brand->id)>{{ $brand->getTranslation('name') }}</option>
                                                        @endforeach
                                                    </select>
                                                    <small
                                            ...
                                            <div class="form-group row" id="seller">
                                                <label
                                                    class="col-xxl-3 col-from-label fs-13">{{translate('Seller')}}</label>
                                                <div class="col-xxl-9">
                                                    <select class="form-control aiz-selectpicker" name="user_id"
                                                        ...
                                                        @foreach (\App\Models\User::where('user_type','seller')->get() as $seller)
                                                            <option value="{{ $seller->id }}" @selected(old('user_id')==
                                                            $seller->id)>{{ $seller->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <small
                                                        class="text-muted">{{translate("You can choose a selller if you'd like to display your product by seller.")}}</small>
                                                </div>
                                            </div>
                                            <!-- Supplier -->
                                            <div class="form-group row" id="supplier">
                                                <label
                                                    class="col-xxl-3 col-from-label fs-13">{{translate('Supplier')}}</label>
                                                <div class="col-xxl-9">
                                                    <select class="form-control aiz-selectpicker" name="supplier_id"
                                                        ...
                                                        @foreach (\App\Models\Supplier::get() as $supplier)
                                                            <option value="{{ $supplier->id }}" @selected(old(
                                                            'supplier_id') ==
                                        ...
                                        <!--   <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label
                                                    class="col-xxl-3 col-from-label fs-13">{{translate('Tag')}}</label>
                                                <div class="col-xxl-9">
                            ...
                            <!-- Status -->
                                ...
                                <div class="w-100">
                                    <!-- enable -->
                                {{--                                <div class="form-group row">--}}
                                {{--                                    <label class="col-md-3 col-from-label">{{translate('Enable Product')}}</label>--}}
                                {{--                                    <div class="col-md-9">--}}
                                {{--                                        <label class="aiz-switch aiz-switch-success mb-0 d-block">--}}
                                {{--                                            <input type="checkbox" name="published" value="1">--}}
                                {{--                                            <span></span>--}}
                                {{--                                        </label>--}}
                                {{--                                        <small class="text-muted">{{ translate('If you enable this, this product will be granted as a enable product.') }}</small>--}}
                                {{--                                    </div>--}}
                                {{--                                </div>--}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control aiz-selectpicker" name="video_provider"
                                                id="video_provider">
                                            <option value="youtube" @selected(old(
                                            'video_provider') == 'youtube')>{{translate('Youtube')}}</option>
                                            <option value="dailymotion" @selected(old(
                                            'video_provider') == 'dailymotion')>{{translate('Dailymotion')}}</option>
                                            <option value="vimeo" @selected(old(
                                            'video_provider') == 'vimeo')>{{translate('Vimeo')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- Video Link -->
                        ...
                        <div class="tab-pane fade" id="price_and_stocks" role="tabpanel"
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                ...
                                <div class="w-100">
                                    ...
                                    <!-- cost-->
                                    <div class="form-group row">
                                        <label class="col-md-3 col-from-label">{{translate('Cost')}} <span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-6">
                                            <input type="number" lang="en" min="0" value="0" step="0.01"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control aiz-selectpicker" name="discount_type">
                                                <option value="amount" @selected(old(
                                                'discount_type') == 'amount')>{{translate('Flat')}}</option>
                                                <option value="percent" @selected(old(
                                                'discount_type') == 'percent')>{{translate('Percent')}}</option>
                                            </select>
                                        </div>
                                    </div>
...
{{--                                    <div class="form-group row">--}}
{{--                                        <label class="col-md-3 col-from-label">{{translate('Show Stock')}}</label>--}}
{{--                                        <div class="col-md-9">--}}
{{--                                            <label class="aiz-switch aiz-switch-success mb-0">--}}
{{--                                                <input type="radio" name="stock_visibility_state" value="quantity"--}}
{{--                                                       checked>--}}
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control aiz-selectpicker"
                                                ...
                                                @foreach (\App\Models\Warranty::all() as $warranty)
                                                    <option value="{{ $warranty->id }}" @selected(old('warranty_id') ==
                                                    $warranty->id)>{{ $warranty->getTranslation('text') }}</option>
                                                @endforeach
                                            </select>
